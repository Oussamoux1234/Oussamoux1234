...
<p align="center">
  <strong>I build reliable tools for complicated systems.</strong><br />
  Agent infrastructure · Distributed backends · Full-stack delivery
</p>
...
| Focus | What I bring |
| --- | --- |
| **Agent infrastructure** | Explicit checkpoints, safe handoffs, schema-backed contracts, and local-first workflows |
| **Backend systems** | Java and Spring services, API gateways, service discovery, event-driven design, and SQL persistence |
| **Product engineering** | TypeScript applications, Next.js interfaces, Node.js APIs, and end-to-end delivery |
| **Developer experience** | Small command-line tools, clear documentation, predictable configuration, and auditable behavior |

## How I work

- **Make state explicit.** Important work should survive a process, tool, or agent boundary.
- **Prefer evidence over ceremony.** Tests, schemas, and observable behavior carry more weight than confident claims.
